"""Legacy semantic chunking using sentence embeddings.

This is the original SemanticChunker implementation. For new projects, use:
...
class SemanticChunker(BaseChunker):
    """Original semantic chunker that splits text into semantically coherent chunks using embeddings.
    
    This is the legacy implementation preserved for backward compatibility.
    For new projects, use the improved version: `from chonkie.chunker import SemanticChunker`
