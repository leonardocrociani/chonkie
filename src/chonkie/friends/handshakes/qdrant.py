...
class QdrantHandshake(BaseHandshake):
        ...
        if collection_name == "random":
            while True:
                ...
                if not self.client.collection_exists(self.collection_name):
                    ...
                    pass
            print(f"🦛 Chonkie created a new collection in Qdrant: {self.collection_name}")
        else:
    ...
    def write(self, chunks: Union[Chunk, Sequence[Chunk]]) -> None:
        ...
        print(f"🦛 Chonkie wrote {len(chunks)} chunks to Qdrant collection: {self.collection_name}")
